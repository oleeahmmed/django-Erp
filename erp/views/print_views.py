...
class PrintSalesQuotationView(View):
    ...
    def get(self, request, quotation_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_sales_quotation.html', context)
...
class PrintDeliveryView(View):
    ...
    def get(self, request, delivery_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_delivery.html', context)
...
class PrintInvoiceView(View):
    ...
    def get(self, request, invoice_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_invoice.html', context)
...
class PrintSalesReturnView(View):
    ...
    def get(self, request, return_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_sales_return.html', context)
...
class PrintQuickSaleView(View):
    ...
    def get(self, request, sale_id, *args, **kwargs):
        sale = QuickSale.objects.prefetch_related('items__product').select_related('customer', 'warehouse', 'user').get(id=sale_id)
        ...
        return render(request, 'admin/erp/print_quick_sale.html', context)
...
class PrintIncomingPaymentView(View):
    ...
    def get(self, request, payment_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_incoming_payment.html', context)
...
class PrintPurchaseQuotationView(View):
    ...
    def get(self, request, quotation_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_purchase_quotation.html', context)
...
class PrintPurchaseOrderView(View):
    ...
    def get(self, request, order_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_purchase_order.html', context)
...
class PrintGoodsReceiptView(View):
    ...
    def get(self, request, receipt_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_goods_receipt.html', context)
...
class PrintGoodsReceiptPOView(View):
    ...
    def get(self, request, receipt_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_goods_receipt_po.html', context)
...
class PrintPurchaseInvoiceView(View):
    ...
    def get(self, request, invoice_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_purchase_invoice.html', context)
...
class PrintPurchaseReturnView(View):
    ...
    def get(self, request, return_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_purchase_return.html', context)
...
class PrintOutgoingPaymentView(View):
    ...
    def get(self, request, payment_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_outgoing_payment.html', context)


# ==================== MANUFACTURING MODULE PRINT VIEWS ====================

from ..models import BillOfMaterials, ProductionOrder, ProductionReceipt
...
class PrintBOMView(View):
    ...
    def get(self, request, bom_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_bom.html', context)
...
class PrintProductionOrderView(View):
    ...
    def get(self, request, order_id, *args, **kwargs):
        ...
        return render(request, 'admin/erp/print_production_order.html', context)
...
class PrintProductionReceiptView(View):
    ...
    def get(self, request, receipt_id, *args, **kwargs):
        receipt = ProductionReceipt.objects.prefetch_related('components__product').select_related(
            'production_order', 'product', 'warehouse'
        ).get(id=receipt_id)
        ...
        return render(request, 'admin/erp/print_production_receipt.html', context)
