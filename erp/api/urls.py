...
from .views import (
    ...
    ProductionReceiptViewSet, ProductionReceiptComponentViewSet,
    # Inventory Control
    ...
    # POS
    QuickSaleViewSet, QuickSaleItemViewSet, UserPOSProfileViewSet,
)
...
router.register(r'production-receipt-components', ProductionReceiptComponentViewSet, basename='productionreceiptcomponent')
...
router.register(r'user-pos-profiles', UserPOSProfileViewSet, basename='userposprofile')
