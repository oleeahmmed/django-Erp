...
from hrm.models import AttendanceLog, Employee, Department, Shift, EmployeeSalary
from hrm.utils import generate_attendance_from_logs
            ...
            if from_date and to_date:
                ...
                for emp in employees:
                    ...
                    while current_date <= to_date:
                        ...
                        from hrm.utils import get_work_day_range
